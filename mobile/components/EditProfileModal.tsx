        ...
        <View className="space-y-4">
          ...
          <View>
            ...
            <TextInput
              ...
              placeholder="Enter Your Bio For Your Profile"
            />
          </View>
          <View>
            <Text className="text-gray-500 text-sm mb-2">Your Location</Text>
            <TextInput
              className="border border-gray-200 rounded-lg p-3 text-base"
              value={formData.location}
              onChangeText={(text) => updateFormField("location", text)}
              placeholder="Fill Your Location For Everyone Know Where You Come From"
            />
          </View>
        </View>
      </ScrollView>
